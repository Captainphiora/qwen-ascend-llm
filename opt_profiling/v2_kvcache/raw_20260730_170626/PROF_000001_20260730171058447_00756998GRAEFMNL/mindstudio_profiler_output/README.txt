...
3.step_trace.csv:Iteration trace data.
...
5.op_summary.csv:AI Core, AI CPU, AI Vector and COMMUNICATION communication operator data,is used to collect statistics on operator details and time consumptions.
