...
class Qwen2Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        kv_seq_len = key_states.shape[-2] + past_key_value.shape[3]
        #         raise ValueError(
        ...
        if past_key_value is not None:
            ...
            layer_kv = past_key_value[:, self.layer_idx]  # [1, 2*num_kv_heads, kv_len, head_dim]
            cache_key = layer_kv[:, :self.num_key_value_heads]  # [1, num_kv_heads, kv_len, head_dim]
            cache_value = layer_kv[:, self.num_key_value_heads:]  # [1, num_kv_heads, kv_len, head_dim]
...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def forward(
        ...
        """
        # reshape for per-layer KV cache access (avoid StridedSlice)
        ...
        )  # [1, num_layers, 2*kv_heads, kv_len, head_dim]
        # copy from chatglm3-6b for onnx export
        past_length = past_key_values.shape[3]
