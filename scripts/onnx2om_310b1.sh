#!/bin/bash
# Step 3: ATC 编译（ONNX → OM）— FP16, Ascend310B1
# 用法: bash scripts/onnx2om_310b1.sh
set -e
...
OM_MODEL_PATH="opt_models/v5_fp16/om_310b1/${MODEL_NAME}_${KV_CACHE_LENGTH}_${MAX_PREFILL_LENGTH}"
# ---- 配置结束 ----

mkdir -p "opt_models/v5_fp16/om_310b1"

echo "============================================================"
echo " [Step 3] ATC 编译 — FP16 (Ascend310B1)"
